...
export default function Home() {
  return (
    <div className="min-h-screen h-full w-full flex flex-col overflow-hidden background">
      <Head>
      ...
      <div className="h-full w-full container max-w-5xl mx-auto flex flex-col items-center pt-4">
        <div className="flex flex-col items-center max-w-4xl w-full">
          <Link href="/mint" passHref>
            <a className="mt-16 font-coiny uppercase inline-flex items-center px-6 oy-2 text-sm sm:text-2xl md:text-3xl font-medium text-center rounded text-amber-200 hover:bg-amber-200 hover:text-white">
          ...
          <img
            ...
            <div className="flex flex-col md:items-start items-center justify-center text-center font-coiny text-neutral-50 px-4 md:px-0 py-10 mt-14">
              <h2 className="font-bold text-2xl md:text-4xl uppercase">
                Built with honesty at the foundation
              </h2>
